...
class CreateTrigger extends Migration
{
    ...
    {
        DB::unprepared('
        CREATE TRIGGER tr_friends_double_accepted AFTER UPDATE ON `friends`
            FOR EACH ROW BEGIN
                IF OLD.user_id_1 = NEW.user_id_1 AND OLD.user_id_2 = NEW.user_id_2 THEN
                    UPDATE friends SET isAccepted = `1` WHERE user_id_1 = NEW.user_id_1 AND user_id_2 = NEW.user_id_2;
                END IF;
                IF OLD.user_id_2 = NEW.user_id_1 AND OLD.user_id_1 = NEW.user_id_2 THEN
